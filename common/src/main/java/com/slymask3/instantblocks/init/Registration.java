...
public class Registration {
    ...
    public static void registerItems(IRegistryHelper<Item> helper) {
        ...
        helper.register(Names.Blocks.IB_WOOD_HOUSE, new InstantBlockItem(ModBlocks.INSTANT_WOOD_HOUSE,properties));
        helper.register(Names.Blocks.IB_MINING_LADDER, new InstantBlockItem(ModBlocks.INSTANT_MINING_LADDER,properties));
        helper.register(Names.Blocks.IB_GLASS_DOME, new InstantBlockItem(ModBlocks.INSTANT_GLASS_DOME,properties));
        helper.register(Names.Blocks.IB_FARM, new InstantBlockItem(ModBlocks.INSTANT_FARM,properties));
        helper.register(Names.Blocks.IB_SKYDIVE, new InstantBlockItem(ModBlocks.INSTANT_SKYDIVE,properties));
        helper.register(Names.Blocks.IB_GRINDER, new InstantBlockItem(ModBlocks.INSTANT_GRINDER,properties));
        helper.register(Names.Blocks.IB_POOL, new InstantBlockItem(ModBlocks.INSTANT_POOL,properties));
        helper.register(Names.Blocks.IB_ESCAPE_LADDER, new InstantBlockItem(ModBlocks.INSTANT_ESCAPE_LADDER,properties));
        helper.register(Names.Blocks.IB_WATER, new InstantBlockItem(ModBlocks.INSTANT_WATER,properties));
        helper.register(Names.Blocks.IB_LAVA, new InstantBlockItem(ModBlocks.INSTANT_LAVA,properties));
        helper.register(Names.Blocks.IB_SUCTION, new InstantBlockItem(ModBlocks.INSTANT_SUCTION,properties));
        helper.register(Names.Blocks.IB_RAIL, new InstantBlockItem(ModBlocks.INSTANT_RAIL,properties));
        helper.register(Names.Blocks.IB_STATUE, new InstantBlockItem(ModBlocks.INSTANT_STATUE,properties));
        helper.register(Names.Blocks.IB_HARVEST, new InstantBlockItem(ModBlocks.INSTANT_HARVEST,properties));
        helper.register(Names.Blocks.IB_LIGHT, new InstantBlockItem(ModBlocks.INSTANT_LIGHT,properties));
        helper.register(Names.Blocks.IB_SCHEMATIC, new InstantBlockItem(ModBlocks.INSTANT_SCHEMATIC,properties));
        helper.register(Names.Blocks.IB_TREE, new InstantBlockItem(ModBlocks.INSTANT_TREE,properties));
        helper.register(Names.Blocks.COLOR, new InstantBlockItem(ModBlocks.COLOR,properties));
        helper.register(Names.Blocks.SKYDIVE_TP, new InstantBlockItem(ModBlocks.SKYDIVE_TP,properties));
