...
public class Strings {
	...
	public static final String ERROR_WAND_DURABILITY = ERROR + "wand_durability";
	...
	public static final String CREATE_SKYDIVE = CREATE + "skydive";
	public static final String CREATE_FARM = CREATE + "farm";
	...
	public static final String CREATE_POOL = CREATE + "pool";
