...
public class SchematicScreen extends InstantScreen {
	...
	public void init() {
		...
		Button open = new Button(this.width / 2 + 134, 48, 20, 20, new TextComponent(">"), (p_88642_) -> {
		...
		this.center = new Checkbox(this.width / 2 - 4 - 150, 72, 150, 20, new TranslatableComponent("ib.gui.schematic.center"), blockEntity.center);
		this.ignoreAir = new Checkbox(this.width / 2 + 4, 72, 150, 20, new TranslatableComponent("ib.gui.schematic.ignore"), blockEntity.ignoreAir);

		this.input = new EditBox(this.font, this.width / 2 - 4 - 150, 49, 284, 18, new TextComponent("Input")) {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		...
		this.font.draw(poseStack, new TranslatableComponent("ib.gui.schematic.found", this.schematics.size()), this.width / 2 - 2 - 150, 98, 0xFFFFFF);
	}
