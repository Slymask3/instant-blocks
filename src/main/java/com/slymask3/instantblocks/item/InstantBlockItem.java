...
public class InstantBlockItem extends BlockItem {
	...
	public void appendHoverText(ItemStack is, @Nullable Level world, List<Component> list, TooltipFlag flag) {
		if(block == ModBlocks.INSTANT_WOOD_HOUSE.get()) {
			...
			list.add(Component.translatable("ib.tooltip.mining_ladder", Config.Common.MINING_LADDER_LAYER.get()));
			...
			list.add(Component.translatable("ib.tooltip.skydive.2", Config.Common.SKYDIVE_MIN.get(), Config.Common.SKYDIVE_MAX.get()));
			...
			list.add(Component.translatable("ib.tooltip.water.max", Config.Common.MAX_LIQUID.get()));
			list.add(Component.translatable("ib.tooltip.liquid.mode", (Config.Common.SIMPLE_LIQUID.get() ? "Simple" : "Full")));
		} else if(block == ModBlocks.INSTANT_LAVA.get()) {
			list.add(Component.translatable("ib.tooltip.lava"));
			list.add(Component.translatable("ib.tooltip.lava.max", Config.Common.MAX_LIQUID.get()));
			list.add(Component.translatable("ib.tooltip.liquid.mode", (Config.Common.SIMPLE_LIQUID.get() ? "Simple" : "Full")));
		} else if(block == ModBlocks.INSTANT_SUCTION.get()) {
			list.add(Component.translatable("ib.tooltip.suction"));
			list.add(Component.translatable("ib.tooltip.suction.max", Config.Common.MAX_FILL.get()));
		} else if(block == ModBlocks.INSTANT_RAIL.get()) {
			list.add(Component.translatable("ib.tooltip.rail", Config.Common.RAILS_AMOUNT.get()));
			...
			list.add(Component.translatable("ib.tooltip.radius", Config.Common.RADIUS_HARVEST.get()));
		} else if(block == ModBlocks.INSTANT_LIGHT.get()) {
			list.add(Component.translatable("ib.tooltip.light"));
			list.add(Component.translatable("ib.tooltip.radius", Config.Common.RADIUS_LIGHT.get()));
			...
			list.add(Component.translatable("ib.tooltip.skydive_tp.2", Config.Common.SKYDIVE_MAX.get() + 2));
			list.add(Component.translatable("ib.tooltip.creative"));
		}
