...
public class InstantHouseWoodBlock extends InstantBlock {
	...
	public boolean build(Level world, int x, int y, int z, Player player) {
		...
		if(direction == Direction.SOUTH) {
			...
			BuildHelper.build(world, x-4, y, z+3, air, 9, 5, 4); //PORCH
			...
			BuildHelper.build(world, x-4, y, z+3, dark, 9, 1, 4); //PORCH FLOOR 1
			BuildHelper.build(world, x-3, y, z+4, light, 7, 1, 2); //PORCH FLOOR 2
			...
			BuildHelper.build(world, x-4, y+1, z-5, light, 9, 4, 1); //WOOD WALL 1
			BuildHelper.build(world, x-4, y+1, z+2, light, 9, 4, 1); //WOOD WALL 2
			BuildHelper.build(world, x-5, y+1, z-4, light, 1, 4, 6); //WOOD WALL 3
			BuildHelper.build(world, x+5, y+1, z-4, light, 1, 4, 6); //WOOD WALL 4
			
			BuildHelper.build(world, x-3, y+2, z-5, pane, 7, 2, 1); //PANE WALL 1
			BuildHelper.build(world, x-3, y+2, z+2, pane, 1, 2, 1); //PANE WALL 2 (1)
			BuildHelper.build(world, x+3, y+2, z+2, pane, 1, 2, 1); //PANE WALL 2 (2)
			BuildHelper.build(world, x-5, y+2, z-3, pane, 1, 2, 4); //PANE WALL 3
			BuildHelper.build(world, x+5, y+2, z-3, pane, 1, 2, 4); //PANE WALL 4

			BuildHelper.build(world, x-1, y+1, z+2, log, 3, 3, 1); //LOG ENTRANCE

			BuildHelper.setBlock(world, x, y+1, z+2,door,directionDoor);

			/************************ Layer 1 to 4 : PORCH ************************/ //DONE
			BuildHelper.build(world, x-4, y+4, z+3, slabD, Direction.UP, 9, 1, 4); //PORCH ROOF 1
			BuildHelper.build(world, x-3, y+4, z+4, slabD, Direction.UP, 7, 1, 2); //PORCH ROOF 2
			...
			BuildHelper.build(world, x-3, y+1, z+6, fence, 7, 1, 1); //PORCH SIDE 3 (FRONT)
			...
			BuildHelper.build(world, x-5, y+5, z+2, slabD, 11, 1, 1); //HOUSE ROOF 2
			BuildHelper.build(world, x-5, y+5, z-4, slabD, 1, 1, 6); //HOUSE ROOF 3
			BuildHelper.build(world, x+5, y+5, z-4, slabD, 1, 1, 6); //HOUSE ROOF 4

			BuildHelper.build(world, x-4, y+5, z-4, light, 9, 1, 1); //HOUSE ROOF 1
			BuildHelper.build(world, x-4, y+5, z+1, light, 9, 1, 1); //HOUSE ROOF 2
			BuildHelper.build(world, x-4, y+5, z-3, light, 1, 1, 4); //HOUSE ROOF 3
			BuildHelper.build(world, x+4, y+5, z-3, light, 1, 1, 4); //HOUSE ROOF 4

			BuildHelper.build(world, x-3, y+6, z-3, slabD, 7, 1, 1); //HOUSE ROOF 1
			BuildHelper.build(world, x-3, y+6, z, slabD, 7, 1, 1); //HOUSE ROOF 2
			BuildHelper.build(world, x-3, y+6, z-2, slabD, 1, 1, 2); //HOUSE ROOF 3
			BuildHelper.build(world, x+3, y+6, z-2, slabD, 1, 1, 2); //HOUSE ROOF 4
		...
		/************************ meta == 1 ************************/
			...
			/************************ Layer 0 to 7 : AIR ************************/
			BuildHelper.build(world, x-2, y, z-5, air, 8, 6, 11); //HOUSE ROOM
			BuildHelper.build(world, x-1, y+5, z-4, air, 6, 1, 9); //HOUSE ROOF 1
			BuildHelper.build(world, x, y+6, z-3, air, 4, 1, 7); //HOUSE ROOF 2

			BuildHelper.build(world, x-6, y, z-4, air, 4, 5, 9); //PORCH

			/************************ Layer 0 : FLOOR ************************/ //GOOD
			BuildHelper.build(world, x-2, y, z-5, dark, 8, 1, 11); //HOME FLOOR 1
			BuildHelper.build(world, x-1, y, z-4, light, 6, 1, 9); //HOME FLOOR 2
			BuildHelper.build(world, x, y, z-3, dark, 4, 1, 7); //HOME FLOOR 3
			BuildHelper.build(world, x+1, y, z-2, light, 2, 1, 5); //HOME FLOOR 4

			BuildHelper.build(world, x-6, y, z-4, dark, 4, 1, 9); //PORCH FLOOR 1
			BuildHelper.build(world, x-5, y, z-3, light, 2, 1, 7); //PORCH FLOOR 2
			...
			BuildHelper.build(world, x+5, y+1, z-4, light, 1, 4, 9); //WOOD WALL 1
			BuildHelper.build(world, x-2, y+1, z-4, light, 1, 4, 9); //WOOD WALL 2
			BuildHelper.build(world, x-1, y+1, z-5, light, 6, 4, 1); //WOOD WALL 3 //GOOD
			BuildHelper.build(world, x-1, y+1, z+5, light, 6, 4, 1); //WOOD WALL 4 //GOOD
			
			BuildHelper.build(world, x+5, y+2, z-3, pane, 1, 2, 7); //PANE WALL 1
			BuildHelper.build(world, x-2, y+2, z-3, pane, 1, 2, 1); //PANE WALL 2 (1)
			BuildHelper.build(world, x-2, y+2, z+3, pane, 1, 2, 1); //PANE WALL 2 (2)
			BuildHelper.build(world, x, y+2, z-5, pane, 4, 2, 1); //PANE WALL 3 //GOOD
			BuildHelper.build(world, x, y+2, z+5, pane, 4, 2, 1); //PANE WALL 4 //GOOD

			BuildHelper.build(world, x-2, y+1, z-1, log, 1, 3, 3); //LOG ENTRANCE

			BuildHelper.setBlock(world, x-2, y+1, z,door,directionDoor);

			/************************ Layer 1 to 4 : PORCH ************************/
			BuildHelper.build(world, x-6, y+4, z-4, slabD, Direction.UP, 4, 1, 9); //PORCH ROOF 1
			BuildHelper.build(world, x-5, y+4, z-3, slabD, Direction.UP, 2, 1, 7); //PORCH ROOF 2
			...
			BuildHelper.build(world, x-5, y+1, z-4, fence, 2, 1, 1); //PORCH SIDE 1
			BuildHelper.build(world, x-5, y+1, z+4, fence, 2, 1, 1); //PORCH SIDE 2
			BuildHelper.build(world, x-6, y+1, z-3, fence, 1, 1, 7); //PORCH SIDE 3 (FRONT)
			...
			BuildHelper.build(world, x-2, y+5, z-5, slabD, 1, 1, 11); //HOUSE ROOF 2
			BuildHelper.build(world, x-1, y+5, z-5, slabD, 6, 1, 1); //HOUSE ROOF 3 //GOOD
			BuildHelper.build(world, x-1, y+5, z+5, slabD, 6, 1, 1); //HOUSE ROOF 4 //GOOD

			BuildHelper.build(world, x+4, y+5, z-4, light, 1, 1, 9); //HOUSE ROOF 1
			BuildHelper.build(world, x-1, y+5, z-4, light, 1, 1, 9); //HOUSE ROOF 2
			BuildHelper.build(world, x, y+5, z-4, light, 4, 1, 1); //HOUSE ROOF 3
			BuildHelper.build(world, x, y+5, z+4, light, 4, 1, 1); //HOUSE ROOF 4

			BuildHelper.build(world, x+3, y+6, z-3, slabD, 1, 1, 7); //HOUSE ROOF 1
			BuildHelper.build(world, x, y+6, z-3, slabD, 1, 1, 7); //HOUSE ROOF 2
			BuildHelper.build(world, x+1, y+6, z-3, slabD, 2, 1, 1); //HOUSE ROOF 3
			BuildHelper.build(world, x+1, y+6, z+3, slabD, 2, 1, 1); //HOUSE ROOF 4

			BuildHelper.build(world, x+1, y+6, z-2, light, 2, 1, 5); //HOUSE ROOF TOP
		...
		/************************ meta == 2 ************************/
			...
			/************************ Layer 0 to 7 : AIR ************************/ //DONE
			BuildHelper.build(world, x-5, y, z-2, air, 11, 6, 8); //HOUSE ROOM
			BuildHelper.build(world, x-4, y+5, z-1, air, 9, 1, 6); //HOUSE ROOF 1
			BuildHelper.build(world, x-3, y+6, z, air, 7, 1, 4); //HOUSE ROOF 2

			BuildHelper.build(world, x-4, y, z-6, air, 9, 5, 4); //PORCH

			/************************ Layer 0 : FLOOR ************************/ //DONE
			BuildHelper.build(world, x-5, y, z-2, dark, 11, 1, 8); //HOME FLOOR 1
			BuildHelper.build(world, x-4, y, z-1, light, 9, 1, 6); //HOME FLOOR 2
			BuildHelper.build(world, x-3, y, z, dark, 7, 1, 4); //HOME FLOOR 3
			BuildHelper.build(world, x-2, y, z+1, light, 5, 1, 2); //HOME FLOOR 4

			BuildHelper.build(world, x-4, y, z-6, dark, 9, 1, 4); //PORCH FLOOR 1
			BuildHelper.build(world, x-3, y, z-5, light, 7, 1, 2); //PORCH FLOOR 2
			...
			BuildHelper.build(world, x-4, y+1, z+5, light, 9, 4, 1); //WOOD WALL 1
			BuildHelper.build(world, x-4, y+1, z-2, light, 9, 4, 1); //WOOD WALL 2
			BuildHelper.build(world, x-5, y+1, z-1, light, 1, 4, 6); //WOOD WALL 3 //GOOD
			BuildHelper.build(world, x+5, y+1, z-1, light, 1, 4, 6); //WOOD WALL 4 //GOOD
			
			BuildHelper.build(world, x-3, y+2, z+5, pane, 7, 2, 1); //PANE WALL 1
			BuildHelper.build(world, x-3, y+2, z-2, pane, 1, 2, 1); //PANE WALL 2 (1)
			BuildHelper.build(world, x+3, y+2, z-2, pane, 1, 2, 1); //PANE WALL 2 (2)
			BuildHelper.build(world, x-5, y+2, z, pane, 1, 2, 4); //PANE WALL 3 //GOOD
			BuildHelper.build(world, x+5, y+2, z, pane, 1, 2, 4); //PANE WALL 4 //GOOD
			...
			/************************ Layer 1 to 4 : PORCH ************************/ //DONE
			BuildHelper.build(world, x-4, y+4, z-6, slabD, Direction.UP, 9, 1, 4); //PORCH ROOF 1
			BuildHelper.build(world, x-3, y+4, z-5, slabD, Direction.UP, 7, 1, 2); //PORCH ROOF 2
			...
			BuildHelper.build(world, x-4, y+1, z-5, fence, 1, 1, 2); //PORCH SIDE 1
			BuildHelper.build(world, x+4, y+1, z-5, fence, 1, 1, 2); //PORCH SIDE 2
			BuildHelper.build(world, x-3, y+1, z-6, fence, 7, 1, 1); //PORCH SIDE 3 (FRONT)
			BuildHelper.setBlock(world,x, y+1, z-6, gate,directionGate); //PORCH GATE
			...
			BuildHelper.build(world, x-5, y+5, z+5, slabD, 11, 1, 1); //HOUSE ROOF 1
			BuildHelper.build(world, x-5, y+5, z-2, slabD, 11, 1, 1); //HOUSE ROOF 2
			BuildHelper.build(world, x-5, y+5, z-1, slabD, 1, 1, 6); //HOUSE ROOF 3 //GOOD
			BuildHelper.build(world, x+5, y+5, z-1, slabD, 1, 1, 6); //HOUSE ROOF 4 //GOOD

			BuildHelper.build(world, x-4, y+5, z+4, light, 9, 1, 1); //HOUSE ROOF 1
			BuildHelper.build(world, x-4, y+5, z-1, light, 9, 1, 1); //HOUSE ROOF 2
			BuildHelper.build(world, x-4, y+5, z, light, 1, 1, 4); //HOUSE ROOF 3
			BuildHelper.build(world, x+4, y+5, z, light, 1, 1, 4); //HOUSE ROOF 4

			BuildHelper.build(world, x-3, y+6, z+3, slabD, 7, 1, 1); //HOUSE ROOF 1
			BuildHelper.build(world, x-3, y+6, z, slabD, 7, 1, 1); //HOUSE ROOF 2
			BuildHelper.build(world, x-3, y+6, z+1, slabD, 1, 1, 2); //HOUSE ROOF 3
			BuildHelper.build(world, x+3, y+6, z+1, slabD, 1, 1, 2); //HOUSE ROOF 4

			BuildHelper.build(world, x-2, y+6, z+1, light, 5, 1, 2); //HOUSE ROOF TOP
		...
		/************************ meta == 3 ************************/
			...
			BuildHelper.build(world, x+3, y, z-4, air, 4, 5, 9); //PORCH
			...
			BuildHelper.build(world, x+3, y, z-4, dark, 4, 1, 9); //PORCH FLOOR 1
			BuildHelper.build(world, x+4, y, z-3, light, 2, 1, 7); //PORCH FLOOR 2
			...
			BuildHelper.build(world, x-5, y+1, z-4, light, 1, 4, 9); //WOOD WALL 1
			BuildHelper.build(world, x+2, y+1, z-4, light, 1, 4, 9); //WOOD WALL 2
			BuildHelper.build(world, x-4, y+1, z-5, light, 6, 4, 1); //WOOD WALL 3
			BuildHelper.build(world, x-4, y+1, z+5, light, 6, 4, 1); //WOOD WALL 4
			
			BuildHelper.build(world, x-5, y+2, z-3, pane, 1, 2, 7); //PANE WALL 1
			BuildHelper.build(world, x+2, y+2, z-3, pane, 1, 2, 1); //PANE WALL 2 (1)
			BuildHelper.build(world, x+2, y+2, z+3, pane, 1, 2, 1); //PANE WALL 2 (2)
			BuildHelper.build(world, x-3, y+2, z-5, pane, 4, 2, 1); //PANE WALL 3
			BuildHelper.build(world, x-3, y+2, z+5, pane, 4, 2, 1); //PANE WALL 4
			...
			/************************ Layer 1 to 4 : PORCH ************************/
			BuildHelper.build(world, x+3, y+4, z-4, slabD, Direction.UP, 4, 1, 9); //PORCH ROOF 1
			BuildHelper.build(world, x+4, y+4, z-3, slabD, Direction.UP, 2, 1, 7); //PORCH ROOF 2
			...
			BuildHelper.build(world, x-5, y+5, z-5, slabD, 1, 1, 11); //HOUSE ROOF 1
			BuildHelper.build(world, x+2, y+5, z-5, slabD, 1, 1, 11); //HOUSE ROOF 2
			BuildHelper.build(world, x-4, y+5, z-5, slabD, 6, 1, 1); //HOUSE ROOF 3
			BuildHelper.build(world, x-4, y+5, z+5, slabD, 6, 1, 1); //HOUSE ROOF 4

			BuildHelper.build(world, x-4, y+5, z-4, light, 1, 1, 9); //HOUSE ROOF 1
			BuildHelper.build(world, x+1, y+5, z-4, light, 1, 1, 9); //HOUSE ROOF 2
			BuildHelper.build(world, x-3, y+5, z-4, light, 4, 1, 1); //HOUSE ROOF 3
			BuildHelper.build(world, x-3, y+5, z+4, light, 4, 1, 1); //HOUSE ROOF 4

			BuildHelper.build(world, x-3, y+6, z-3, slabD, 1, 1, 7); //HOUSE ROOF 1
			BuildHelper.build(world, x, y+6, z-3, slabD, 1, 1, 7); //HOUSE ROOF 2
			BuildHelper.build(world, x-2, y+6, z-3, slabD, 2, 1, 1); //HOUSE ROOF 3
			BuildHelper.build(world, x-2, y+6, z+3, slabD, 2, 1, 1); //HOUSE ROOF 4
