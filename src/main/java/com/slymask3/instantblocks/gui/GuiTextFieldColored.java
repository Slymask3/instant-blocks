...
public class GuiTextFieldColored extends Gui
{
    ...
    public GuiTextFieldColored(FontRenderer font, int x, int y, int width, int height) {
        this.field_146211_a = font;
        this.xPosition = x;
        this.yPosition = y;
        this.width = width;
        this.height = height;
    ...
    public GuiTextFieldColored(FontRenderer font, int x, int y, int width, int height, int textColor, int borderColor) {
        this.field_146211_a = font;
        this.xPosition = x;
        this.yPosition = y;
        this.width = width;
        ...
        this.borderColor = toNegative(borderColor);
    }
