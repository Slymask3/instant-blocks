...
public abstract class GuiList2 {
	...
	public GuiList2(Minecraft mc, int width, int height, int top, int bottom, int slotHeight){
		this.mc = mc;
		this.height = height;
		this.width = width;
		this.top = top;
	...
	public void drawScreen(int mouseX, int mouseY, float f){
		...
		mc.getTextureManager().bindTexture(new ResourceLocation("/gui/background.png"));
